            ...
            if (fs.existsSync(androidPath)) {
				...
				while (i < program_dir.length && !foundStudio) {
                    if (program_dir[i].startsWith('Android Studio')) {
                        foundStudio = true;
                        androidStudioPath = path.join(process.env['ProgramFiles'], 'Android', 'gradle');
                    } else { ++i; }
                }
            }
        } else {
		console.log('Hola gradle');
            ...
            androidStudioPath = path.join(process.env['ProgramFiles'], 'Android\sdk\tools\templates\bin', 'gradle');
        }
    }
